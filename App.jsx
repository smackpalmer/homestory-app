        ...
        <div>
          ...
          <div style={{marginBottom:16}}>
            ...
            {Object.entries(JOB_TAGS).map(([category, tags])=>(
              (selectedType==="roof" || selectedType==="new_construction" || selectedType?.startsWith("insulation") || !["Roof Details","Damage Type","Materials","Warranty","New Construction","Insulation R-Value","Insulation Location"].includes(category)) ? (
