  ...
  const download = () => {
    import("jspdf").then(({jsPDF}) => {
      ...
      sorted.forEach(ev => {
        ...
        doc.text(`${ev.source}${ev.verified?" · Verified":""}`, margin+8, y); y += 6;
      });
      ...
      <div style={{width:"100%",maxWidth:400}}>
        ...
        <div style={{display:"flex",flexDirection:"column",gap:12}}>
          {[
            ...
            {role:"landlord",   icon:"🏘️", title:"Landlord",          color:"#0ea5e9", desc:"Manage rental units, inspections, maintenance requests, and tenant documentation"},
...
function ContractorDashboard({properties, onSelect, onLogJob, userTier='free', onUpgrade}) {
